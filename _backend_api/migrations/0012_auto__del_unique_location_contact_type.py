...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Location', fields ['contact_type']
        db.delete_unique(u'_backend_api_location', ['contact_type'])


    def backwards(self, orm):
        # Adding unique constraint on 'Location', fields ['contact_type']
        db.create_unique(u'_backend_api_location', ['contact_type'])
