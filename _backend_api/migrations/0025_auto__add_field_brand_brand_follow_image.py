...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Brand.brand_follow_image'
        db.add_column(u'_backend_api_brand', 'brand_follow_image',
                      self.gf('cloudinary.models.CloudinaryField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Brand.brand_follow_image'
        db.delete_column(u'_backend_api_brand', 'brand_follow_image')
    ...
    models = {
        u'_backend_api.brand': {
            ...
            'brand_follow_image': ('cloudinary.models.CloudinaryField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
