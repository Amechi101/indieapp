...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Brand.brand_detail_slug'
        db.delete_column(u'_backend_api_brand', 'brand_detail_slug')

        # Adding field 'Brand.slug'
        db.add_column(u'_backend_api_brand', 'slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=255, unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Brand.brand_detail_slug'
        db.add_column(u'_backend_api_brand', 'brand_detail_slug',
                      self.gf('django.db.models.fields.SlugField')(unique=True, max_length=255, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Brand.slug'
        db.delete_column(u'_backend_api_brand', 'slug')
