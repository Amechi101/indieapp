...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductExtend.product_slug_url'
        db.add_column(u'product_extend_productextend', 'product_slug_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProductExtend.product_website'
        db.add_column(u'product_extend_productextend', 'product_website',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)
        ...
        # Adding field 'ProductExtend.product_img'
        db.add_column(u'product_extend_productextend', 'product_img',
    ...
    def backwards(self, orm):
        # Deleting field 'ProductExtend.product_slug_url'
        db.delete_column(u'product_extend_productextend', 'product_slug_url')

        # Deleting field 'ProductExtend.product_website'
        db.delete_column(u'product_extend_productextend', 'product_website')

        # Deleting field 'ProductExtend.product_website_name'
        db.delete_column(u'product_extend_productextend', 'product_website_name')

        # Deleting field 'ProductExtend.product_img'
        db.delete_column(u'product_extend_productextend', 'product_img')
