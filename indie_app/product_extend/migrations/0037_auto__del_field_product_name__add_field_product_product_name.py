...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Product.product_name'
        db.add_column(u'product_extend_product', 'product_name',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Product.product_name'
        db.delete_column(u'product_extend_product', 'product_name')
