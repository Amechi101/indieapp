...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Product.product_image'
        db.add_column(u'product_extend_product', 'product_image',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Product.product_image'
        db.delete_column(u'product_extend_product', 'product_image')
